...
folder are mapped to the application's root namespace, 'StackOverFlow_es'. This is set in
`"app.json"`:
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'StackOverFlow_es' in the same way
as `"StackOverFlow_es/sass/src"`.
